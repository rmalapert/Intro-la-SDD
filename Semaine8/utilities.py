...
# jupyter:
#   jupytext:
#     cell_metadata_filter: all,-autoscroll,-collapsed,-scrolled,-trusted,-ExecuteTime,-jp-MarkdownHeadingCollapsed,-user_expressions
...
def crop_image(img: Image.Image, crop_size: int = 32) -> Image.Image:
    ...
    raise NotImplementedError("code non implanté ligne 37");
    return cropped_img
...
def crop_around_center(img, center, crop_size=32):
    ...
    # Remplacer la ligne suivante par le code adéquat
    raise NotImplementedError("code non implanté ligne 54");
    # Then crop the image to that box
...
def df_cross_validate(df, sklearn_model, sklearn_metric, n=10, verbose=False):
    ...
    for train_index, test_index in SSS.split(X, Y):
        ...
        # Remplacer la ligne suivante par le code adéquat
        raise NotImplementedError("code non implanté ligne 93");
        #2. Fit the model
        ...
        # Remplacer la ligne suivante par le code adéquat
        raise NotImplementedError("code non implanté ligne 102");
...
def analyze_model_experiments(result_df):
    # Remplacer la ligne suivante par le code adéquat
    raise NotImplementedError("code non implanté ligne 390");
